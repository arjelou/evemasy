        ...
        <div className="h-screen flex items-center justify-center">
          ...
          <form className='bg-slate-300 p-7 rounded-sm'>
                ...
                <label className='block mt-3'>
                    ...
                    className='h-[100px] border border-slate-400 py-3 block mt-1 px-2 bg-slate-300 rounded-sm placeholder-slate-500 focus:outline-none focus:border-orange-600 font-poppins font-medium focus:right-1 sm:text-sm w-full'/>
                </label>
